 ...
 *      timestmp.c - get the timestamp of a file or archive member
...
BEGIN
    ...
    if((s = getoptval(optv, 'v', 0))) {
        ...
        printf("(C) 1993-2003 Christopher Seiwald, see github.com/lkujaw/jam\n");
...
#if _sys_utsname
    {
        ...
        if(uname(&u) >= 0) {
            LIST *l = L0;
# if _mem_machine_utsname
            l = list_new(l, u.machine, 0);
# endif
# if _mem_version_utsname
            l = list_new(l, u.version, 0);
# endif
# if _mem_release_utsname
            l = list_new(l, u.release, 0);
# endif
# if _mem_nodename_utsname
            l = list_new(l, u.nodename, 0);
# endif
# if _mem_sysname_utsname
